...
c=~r.qsa(d,b).indexOf(a),f&&P.removeChild(a),c},J=function(a){return a.replace(/-+(.)?/g,function(a,b){return b?b.toUpperCase():""})},E=function(a){return B.call(a,function(b,d){return a.indexOf(b)==d})},r.fragment=function(a,u,d){a.replace&&(a=a.replace(R,"<$1></$2>"));u===p&&(u=L.test(a)&&RegExp.$1);u in O||(u="*");var c,f,e=O[u];return e.innerHTML=""+a,f=b.each(A.call(e.childNodes),function(){e.removeChild(this)}),x(d)&&(c=b(f),b.each(d,function(a,b){-1<S.indexOf(a)?c[a](b):c.attr(a,b)})),f},r.Z=
function(a,b){return a=a||[],a.__proto__=arguments.callee.prototype,a.selector=b||"",a},r.isZ=function(a){return a instanceof r.Z},r.init=function(a,u){if(!a)return r.Z();if(c(a))return b(w).ready(a);if(r.isZ(a))return a;var d;if(e(a))d=y(a);else if(l(a))d=[x(a)?b.extend({},a):a],a=null;else if(L.test(a))d=r.fragment(a.trim(),RegExp.$1,u),a=null;else{if(u!==p)return b(u).find(a);d=r.qsa(w,a)}return r.Z(d,a)},b=function(a,b){return r.init(a,b)},b.extend=function(a){var b,d=A.call(arguments,1);return"boolean"==
...
d.parentNode;return b(d)},parents:function(a){for(var c=[],d=this;0<d.length;)d=b.map(d,function(a){if((a=a.parentNode)&&a!==w&&0>c.indexOf(a))return c.push(a),a});return q(c,a)},parent:function(a){return q(E(this.pluck("parentNode")),a)},children:function(a){return q(this.map(function(){return h(this)}),a)},contents:function(){return this.map(function(){return A.call(this.childNodes)})},siblings:function(a){return q(this.map(function(a,b){return B.call(h(b.parentNode),function(a){return a!==b})}),
...
this},clone:function(){return this.map(function(){return this.cloneNode(!0)})},hide:function(){return this.css("display","none")},toggle:function(a){return this.each(function(){var c=b(this);(a===p?"none"==c.css("display"):a)?c.show():c.hide()})},prev:function(a){return b(this.pluck("previousElementSibling")).filter(a||"*")},next:function(a){return b(this.pluck("nextElementSibling")).filter(a||"*")},html:function(a){return a===p?0<this.length?this[0].innerHTML:null:this.each(function(c){var d=this.innerHTML;
b(this).empty().append(k(this,a,c,d))})},text:function(a){return a===p?0<this.length?this[0].textContent:null:this.each(function(){this.textContent=a})},attr:function(a,b){var c;return"string"==typeof a&&b===p?0==this.length||1!==this[0].nodeType?p:"value"==a&&"INPUT"==this[0].nodeName?this.val():!(c=this[0].getAttribute(a))&&a in this[0]?this[0][a]:c:this.each(function(c){if(1===this.nodeType)if(l(a))for(t in a){c=t;var d=a[t];null==d?this.removeAttribute(c):this.setAttribute(c,d)}else c=k(this,
b,c,this.getAttribute(a)),null==c?this.removeAttribute(a):this.setAttribute(a,c)})},removeAttr:function(a){return this.each(function(){1===this.nodeType&&this.removeAttribute(a)})},prop:function(a,b){return b===p?this[0]?this[0][a]:p:this.each(function(c){this[a]=k(this,b,c,this[a])})},data:function(a,b){var c=this.attr("data-"+n(a),b);return null!==c?C(c):p},val:function(a){return a===p?0<this.length?this[0].multiple?b(this[0]).find("option").filter(function(a){return this.selected}).pluck("value"):
this[0].value:p:this.each(function(b){this.value=k(this,a,b,this.value)})},offset:function(){if(0==this.length)return null;var a=this[0].getBoundingClientRect();return{left:a.left+window.pageXOffset,top:a.top+window.pageYOffset,width:a.width,height:a.height}},css:function(a,b){if(2>arguments.length&&"string"==typeof a)return 0==this.length?p:this[0].style[J(a)]||H(this[0],"").getPropertyValue(a);var c="";for(t in a)!a[t]&&0!==a[t]?this.each(function(){this.style.removeProperty(n(t))}):c+=n(t)+":"+
("number"==typeof a[t]&&!K[n(t)]?a[t]+"px":a[t])+";";return"string"==typeof a&&(!b&&0!==b?this.each(function(){this.style.removeProperty(n(a))}):c=n(a)+":"+("number"==typeof b&&!K[n(a)]?b+"px":b)),this.each(function(){this.style.cssText+=";"+c})},index:function(a){return a?this.indexOf(b(a)[0]):this.parent().children().indexOf(this[0])},hasClass:function(a){return 1>this.length?!1:s(a).test(z(this[0]))},addClass:function(a){return this.each(function(c){f=[];var d=z(this);k(this,a,c,d).split(/\s+/g).forEach(function(a){b(this).hasClass(a)||
f.push(a)},this);f.length&&z(this,d+(d?" ":"")+f.join(" "))})},removeClass:function(a){return this.each(function(b){if(a===p)return z(this,"");f=z(this);k(this,a,b,f).split(/\s+/g).forEach(function(a){f=f.replace(s(a)," ")});z(this,f.trim())})},toggleClass:function(a,c){return this.each(function(d){d=k(this,a,d,z(this));(c===p?!b(this).hasClass(d):c)?b(this).addClass(d):b(this).removeClass(d)})},scrollTop:function(){if(this.length)return"scrollTop"in this[0]?this[0].scrollTop:this[0].scrollY},position:function(){if(this.length){var a=
...
return a})}},["width","height"].forEach(function(a){b.fn[a]=function(c){var d,f=a.replace(/./,function(a){return a[0].toUpperCase()});return c===p?this[0]==window?window["inner"+f]:this[0]==w?w.documentElement["offset"+f]:(d=this.offset())&&d[a]:this.each(function(d){var f=b(this);f.css(a,k(this,c,d,f[a]()))})}}),["after","prepend","before","append"].forEach(function(a,c){var d=c%2;b.fn[a]=function(){var a=b.map(arguments,function(a){return l(a)?a:r.fragment(a)}),f,e=1<this.length;return 1>a.length?
...
(function(c){function l(b){return b._zid||(b._zid=q++)}function x(b,c,g,h){c=e(c);if(c.ns)var k=RegExp("(?:^| )"+c.ns.replace(" "," .* ?")+"(?: |$)");return(v[l(b)]||[]).filter(function(b){return b&&(!c.e||b.e==c.e)&&(!c.ns||k.test(b.ns))&&(!g||l(b.fn)===l(g))&&(!h||b.sel==h)})}function e(b){b=(""+b).split(".");return{e:b[0],ns:b.slice(1).sort().join(" ")}}function g(b,f,e){c.isObject(b)?c.each(b,e):b.split(/\s/).forEach(function(b){e(b,f)})}function y(b,f,m,h,k,n){var q=l(b),p=v[q]||(v[q]=[]);g(f,
m,function(f,g){var m=e(f);m.fn=g;m.sel=h;m.e in z&&(g=function(b){var f=b.relatedTarget;if(!f||f!==this&&!c.contains(this,f))return m.fn.apply(this,arguments)});m.del=k&&k(g,f);var q=m.del||g;m.proxy=function(c){var f=q.apply(b,[c].concat(c.data));return!1===f&&(c.preventDefault(),c.stopPropagation()),f};m.i=p.length;p.push(m);b.addEventListener(z[m.e]||m.e,m.proxy,m.del&&("focus"==m.e||"blur"==m.e)||!!n)})}function n(b,c,e,h,k){var q=l(b);g(c||"",e,function(c,f){x(b,c,f,h).forEach(function(c){delete v[q][c.i];
b.removeEventListener(z[c.e]||c.e,c.proxy,c.del&&("focus"==c.e||"blur"==c.e)||!!k)})})}function s(b){var f,e={originalEvent:b};for(f in b)!p.test(f)&&void 0!==b[f]&&(e[f]=b[f]);return c.each(t,function(c,f){e[c]=function(){return this[f]=C,b[c].apply(b,arguments)};e[f]=D}),e}function h(b){if(!("defaultPrevented"in b)){b.defaultPrevented=!1;var c=b.preventDefault;b.preventDefault=function(){this.defaultPrevented=!0;c.call(this)}}}var v={},q=1,k={},z={mouseenter:"mouseover",mouseleave:"mouseout"};k.click=
k.mousedown=k.mouseup=k.mousemove="MouseEvents";c.event={add:y,remove:n};c.proxy=function(b,f){if(c.isFunction(b)){var e=function(){return b.apply(f,arguments)};return e._zid=l(b),e}if("string"==typeof f)return c.proxy(b[f],b);throw new TypeError("expected function");};c.fn.bind=function(b,c){return this.each(function(){y(this,b,c)})};c.fn.unbind=function(b,c){return this.each(function(){n(this,b,c)})};c.fn.one=function(b,c){return this.each(function(e,g){y(this,b,c,null,function(b,c){return function(){var f=
b.apply(g,arguments);return n(g,c,b),f}})})};var C=function(){return!0},D=function(){return!1},p=/^([A-Z]|layer[XY]$)/,t={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};c.fn.delegate=function(b,f,e){return this.each(function(g,h){y(h,f,e,b,function(f){return function(e){var g,m=c(e.target).closest(b,h).get(0);if(m)return g=c.extend(s(e),{currentTarget:m,liveFired:h}),f.apply(m,[g].concat([].slice.call(arguments,
1)))}})})};c.fn.undelegate=function(b,c,e){return this.each(function(){n(this,c,e,b)})};c.fn.live=function(b,f){return c(document.body).delegate(this.selector,b,f),this};c.fn.die=function(b,f){return c(document.body).undelegate(this.selector,b,f),this};c.fn.on=function(b,f,e){return!f||c.isFunction(f)?this.bind(b,f||e):this.delegate(f,b,e)};c.fn.off=function(b,f,e){return!f||c.isFunction(f)?this.unbind(b,f||e):this.undelegate(f,b,e)};c.fn.trigger=function(b,f){if("string"==typeof b||c.isPlainObject(b))b=
c.Event(b);return h(b),b.data=f,this.each(function(){"dispatchEvent"in this&&this.dispatchEvent(b)})};c.fn.triggerHandler=function(b,f){var e,g;return this.each(function(h,k){e=s("string"==typeof b?c.Event(b):b);e.data=f;e.target=k;c.each(x(k,b.type||b),function(b,c){g=c.proxy(e);if(e.isImmediatePropagationStopped())return!1})}),g};"focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select keydown keypress keyup error".split(" ").forEach(function(b){c.fn[b]=
function(c){return c?this.bind(b,c):this.trigger(b)}});["focus","blur"].forEach(function(b){c.fn[b]=function(c){return c?this.bind(b,c):this.each(function(){try{this[b]()}catch(c){}}),this}});c.Event=function(b,c){"string"!=typeof b&&(c=b,b=c.type);var e=document.createEvent(k[b]||"Events"),g=!0;if(c)for(var h in c)"bubbles"==h?g=!!c[h]:e[h]=c[h];return e.initEvent(b,g,!0,null,null,null,null,null,null,null,null,null,null,null,null),e.isDefaultPrevented=function(){return this.defaultPrevented},e}})(Zepto);
(function(c){function l(e,v){var q=e[s],q=q&&g[q];if(void 0===v)return q||x(e);if(q){if(v in q)return q[v];var k=n(v);if(k in q)return q[k]}return y.call(c(e),v)}function x(h,v,q){var k=h[s]||(h[s]=++c.uuid);h=g[k]||(g[k]=e(h));return void 0!==v&&(h[n(v)]=q),h}function e(e){var g={};return c.each(e.attributes,function(e,h){0==h.name.indexOf("data-")&&(g[n(h.name.replace("data-",""))]=c.zepto.deserializeValue(h.value))}),g}var g={},y=c.fn.data,n=c.camelCase,s=c.expando="Zepto"+ +new Date;c.fn.data=
function(e,g){return void 0===g?c.isPlainObject(e)?this.each(function(g,k){c.each(e,function(c,e){x(k,c,e)})}):0==this.length?void 0:l(this[0],e):this.each(function(){x(this,e,g)})};c.fn.removeData=function(e){return"string"==typeof e&&(e=e.split(/\s+/)),this.each(function(){var v=this[s],q=v&&g[v];q&&c.each(e,function(){delete q[n(this)]})})}})(Zepto);!function(c){var l=function(c){this.defined="undefined"!==typeof localStorage};l.prototype={constructor:l,get:function(c,g){return localStorage.getItem(c)?localStorage.getItem(c):"undefined"!==typeof g?g:null},has:function(c){return localStorage.getItem(c)?!0:!1},set:function(c,g,l){"string"===typeof g&&(""===g?this.destroy(c):localStorage.setItem(c,g));return"function"===typeof l?l():!0},destroy:function(c,g){localStorage.removeItem(c);return"function"===typeof g?g():!0},clean:function(c){for(var g=
localStorage.length-1;0<=g;g--)"undefined"===typeof Array.indexOf&&-1!==localStorage.key(g).indexOf("garlic:")&&localStorage.removeItem(localStorage.key(g));return"function"===typeof c?c():!0},clear:function(c){localStorage.clear();return"function"===typeof c?c():!0}};var x=function(c,g,l){this.init("garlic",c,g,l)};x.prototype={constructor:x,init:function(e,g,l,n){this.type=e;this.$element=c(g);this.options=this.getOptions(n);this.storage=l;this.path=this.options.getPath(this.$element)||this.getPath();
...
remove:function(){this.remove();this.$element.is("input[type=radio], input[type=checkbox]")?c(this.$element).prop("checked",!1):this.$element.val("")},getPath:function(e){"undefined"===typeof e&&(e=this.$element);if(this.options.getPath(e))return this.options.getPath(e);if(1!=e.length)return!1;for(var g="",l=e.is("input[type=checkbox]"),n=e;n.length;){e=n[0];var s=e.nodeName;if(!s)break;var s=s.toLowerCase(),n=n.parent(),h=n.children(s);if(c(e).is("form, input, select, textarea")||l)if(s+=c(e).attr("name")?
"."+c(e).attr("name"):"",1<h.length&&!c(e).is("input[type=radio]")&&(s+=":eq("+h.index(e)+")"),g=s+(g?">"+g:""),"form"==e.nodeName.toLowerCase())break}return"garlic:"+document.domain+(this.options.domain?"*":window.location.pathname)+">"+g},getStorage:function(){return this.storage}};c.fn.garlic=function(e,g){function y(g){var h=c(g),k=h.data("garlic"),l=c.extend({},n,h.data());if(("undefined"===typeof l.storage||l.storage)&&"password"!==c(g).attr("type"))if(k||h.data("garlic",k=new x(g,s,l)),"string"===
typeof e&&"function"===typeof k[e])return k[e]()}var n=c.extend(!0,{},c.fn.garlic.defaults,e,this.data()),s=new l,h=!1;if(!s.defined)return!1;this.each(function(){c(this).is("form")?c(this).find(n.inputs).each(function(){h=y(c(this))}):c(this).is(n.inputs)&&(h=y(c(this)))});return"function"===typeof g?g():h};c.fn.garlic.Constructor=x;c.fn.garlic.defaults={destroy:!0,inputs:"input, textarea, select",events:"DOMAttrModified textInput input change click keypress paste focus".split(" "),domain:!1,expires:!1,
conflictManager:{enabled:!1,garlicPriority:!0,template:'<span class="garlic-swap"></span>',message:"This is your saved data. Click here to see default one",onConflictDetected:function(c,g){return!0}},getPath:function(c){},onRetrieve:function(c,g){},onPersist:function(c,g){}};c(window).on("load",function(){c('[data-persist="garlic"]').each(function(){c(this).garlic()})})}(window.jQuery||window.Zepto);
