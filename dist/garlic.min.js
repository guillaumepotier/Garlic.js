...
b.on("click",!1,a.proxy(this.swap,this))},swap:function(){var b=this.$element.data("swap-data");this.$element.data("swap-state","garlic"===this.$element.data("swap-state")?"default":"garlic");this.$element.data("swap-data",this.$element.val());a(this.$element).val(b)},destroy:function(){this.storage.destroy(this.path)},remove:function(){this.remove();this.$element.is("input[type=radio], input[type=checkbox]")?a(this.$element).attr("checked",!1):this.$element.val("")},getPath:function(){if(this.$element.length!=
1)return!1;for(var b="",c=this.$element.is("input[type=checkbox]"),d=this.$element;d.length;){var e=d[0],g=e.nodeName;if(!g)break;g=g.toLowerCase();d=d.parent();var f=d.children(g);if(a(e).is("form, input, select, textarea")||c)if(g+=a(e).attr("name")?"."+a(e).attr("name"):"",f.length>1&&!a(e).is("input[type=radio]")&&(g+=":eq("+f.index(e)+")"),b=g+(b?">"+b:""),"form"==e.nodeName.toLowerCase())break}return"garlic:"+document.domain+(this.options.domain?"*":window.location.pathname)+">"+b},getStorage:function(){return this.storage}};
a.fn.garlic=function(b,c){function d(c){var d=a(c),f=d.data("garlic"),h=a.extend({},e,d.data());if("undefined"===typeof h.storage||h.storage)if(f||d.data("garlic",f=new i(c,g,h)),"string"===typeof b&&"function"===typeof f[b])return f[b]()}var e=a.extend(!0,{},a.fn.garlic.defaults,b,this.data()),g=new h,f=!1;if(!g.defined)return!1;this.each(function(){a(this).is("form")?a(this).find(e.inputs).each(function(){f=d(a(this))}):a(this).is(e.inputs)&&(f=d(a(this)))});return"function"===typeof c?c():f};a.fn.garlic.Constructor=
