...
!function ($) {
  ...
  Garlic.prototype = {
    ...
    */
    , getPath: function ( elem ) {
      ...
      var domain = ( this.options.domain ? '*' : window.location.pathname ) + '>';
      var hash = this.options.supportHash && window.location.hash.length ? window.location.hash.replace('#', '') : '';

      return 'garlic:' + document.domain + domain + (hash.length ? hash + '>' : '') + path;
    }
  ...
  * ========================= */
  ...
  $.fn.garlic.defaults = {
    ...
    , supportHash: true                                                                                     // Support hashes in url
